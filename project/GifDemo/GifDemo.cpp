                     ...
                     _In_ int       nCmdShow)
{
    ...
    PathAppend(szPath, L"\\..\\..\\..\\test\\elephant.gif");
    if (!g_gifLoader.LoadImage(szPath))
    {
    ...
    LoadStringW(hInstance, IDC_GIFDEMO, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_GIFDEMO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GIFDEMO));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_GIFDEMO);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        UINT32 nDelayMS = 0;
        Bitmap* pBmp = g_gifLoader.GetFrameAt(g_nCurrentFrameID, nDelayMS);
        if (pBmp)
        {
    ...
    case WM_TIMER:
        ...
        {
            g_nCurrentFrameID++;
            g_nCurrentFrameID %= g_gifLoader.GetFrameCount();
            RECT rc;
